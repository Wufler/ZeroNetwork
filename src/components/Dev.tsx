...
export default function Dev({ h1 }: { h1?: string }) {
  return (
    <main className="flex justify-center items-center min-h-dvh px-6 py-24 sm:py-32 lg:px-8 relative overflow-hidden">
      ...
      <div className="text-center relative z-10 bg-background/80 backdrop-blur-xl p-12 rounded-3xl border border-border shadow-xl">
        <div className="flex justify-center mb-6">
          <div className="p-4 rounded-full bg-orange-100 dark:bg-orange-500/10 text-orange-600 dark:text-orange-500 shadow-sm">
        ...
        <p className="mt-4 text-base leading-7 text-muted-foreground max-w-md mx-auto">
          We&apos;re currently working on making things better. Please check
          back later!
        </p>
      </div>
    </main>
